...
class MeshDrawer {
	...
	constructor() {
		...
		this.vertNormLoc = gl.getAttribLocation(this.prog, 'normal');
		...
		//Done
		this.ambientLight = gl.getUniformLocation(this.prog, "ambient");
	...
	draw(trans) {
		...
		gl.bindBuffer(gl.ARRAY_BUFFER, this.normbuffer);
    	gl.enableVertexAttribArray(this.vertNormLoc);
    	gl.vertexAttribPointer(this.vertNormLoc, 3, gl.FLOAT, false, 0, 0);
		...
		gl.uniform1f(this.ambientLight, this.ambient);
